...
namespace Form2 {
    ...
    public partial class customersDataSet : global::System.Data.DataSet {
        ...
        public partial class customersDataTable : global::System.Data.TypedTableBase<customersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public customersRow AddcustomersRow(int idCustomers, string Name, string Address, string Contact_Info) {
            ...
            internal void InitVars() {
                ...
                this.columnContact_Info = base.Columns["Contact Info"];
            }
            ...
            private void InitClass() {
                ...
                this.columnContact_Info = new global::System.Data.DataColumn("Contact Info", typeof(string), null, global::System.Data.MappingType.Element);
            ...
            public string Contact_Info {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Contact Info\' in table \'customers\' is DBNull.", e);
                    }
                }
                set {
...
namespace Form2.customersDataSetTableAdapters {
    ...
    public partial class customersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Contact Info", "Contact Info");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `customers` WHERE ((`idCustomers` = @p1) AND ((@p2 = 1 AND `Name` IS " +
                "NULL) OR (`Name` = @p3)) AND ((@p4 = 1 AND `Address` IS NULL) OR (`Address` = @p" +
                "5)) AND ((@p6 = 1 AND `Contact Info` IS NULL) OR (`Contact Info` = @p7)))";
            ...
            param.SourceColumn = "idCustomers";
            ...
            param.MySqlDbType = global::MySql.Data.MySqlClient.MySqlDbType.Int32;
            param.IsNullable = true;
            param.SourceColumn = "Contact Info";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            param.SourceColumnNullMapping = true;
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::MySql.Data.MySqlClient.MySqlParameter();
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `customers` (`idCustomers`, `Name`, `Address`, `Contact Info`) VALUES" +
                " (@p1, @p2, @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `customers` SET `idCustomers` = @p1, `Name` = @p2, `Address` = @p3, `Contact Info` = @p4 WHERE ((`idCustomers` = @p5) AND ((@p6 = 1 AND `Name` IS NULL) OR (`Name` = @p7)) AND ((@p8 = 1 AND `Address` IS NULL) OR (`Address` = @p9)) AND ((@p10 = 1 AND `Contact Info` IS NULL) OR (`Contact Info` = @p11)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Form2.Properties.Settings.Default.customersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `idCustomers`, `Name`, `Address`, `Contact Info` FROM `customers`";
